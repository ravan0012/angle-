...
let handler  = async (m, { conn, args, usedPrefix, command }) => {
  ...
  } else throw 'Cannot build a bot inside a bot! \ N \ nhttps: //wa.me/' + global.conn.user.jid.split`@`[0] + '?text=.jadibot'
}
